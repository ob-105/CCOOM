...
-- (i16 each), front_sector(u16), back_sector(u16)], sprite_count(u16),
-- sprites[x,y,floor_z,angle(i16 each), tex_id(u8)].
...
function Level.parse(data, BinReaderModule)
  ...
  local spriteCount = r:u16()
  local sprites = {}
  for i = 1, spriteCount do
    sprites[i] = {
      x = r:i16(), y = r:i16(), floor_z = r:i16(), angle = r:i16(),
      tex_id = r:u8(),
    }
  end
